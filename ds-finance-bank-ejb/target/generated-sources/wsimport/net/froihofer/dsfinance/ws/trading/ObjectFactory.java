 ...
 * generated in the net.froihofer.dsfinance.ws.trading package. 
...
public class ObjectFactory {
    ...
    private static final QName _Buy_QNAME = new QName("http://trading.ws.dsfinance.froihofer.net/", "buy");
    private static final QName _BuyResponse_QNAME = new QName("http://trading.ws.dsfinance.froihofer.net/", "buyResponse");
    private static final QName _FindStockQuotesByCompanyName_QNAME = new QName("http://trading.ws.dsfinance.froihofer.net/", "findStockQuotesByCompanyName");
    private static final QName _FindStockQuotesByCompanyNameResponse_QNAME = new QName("http://trading.ws.dsfinance.froihofer.net/", "findStockQuotesByCompanyNameResponse");
    private static final QName _GetStockQuoteHistory_QNAME = new QName("http://trading.ws.dsfinance.froihofer.net/", "getStockQuoteHistory");
    private static final QName _GetStockQuoteHistoryResponse_QNAME = new QName("http://trading.ws.dsfinance.froihofer.net/", "getStockQuoteHistoryResponse");
    private static final QName _GetStockQuotes_QNAME = new QName("http://trading.ws.dsfinance.froihofer.net/", "getStockQuotes");
    private static final QName _GetStockQuotesResponse_QNAME = new QName("http://trading.ws.dsfinance.froihofer.net/", "getStockQuotesResponse");
    private static final QName _Sell_QNAME = new QName("http://trading.ws.dsfinance.froihofer.net/", "sell");
    private static final QName _SellResponse_QNAME = new QName("http://trading.ws.dsfinance.froihofer.net/", "sellResponse");
    private static final QName _TradingWSException_QNAME = new QName("http://trading.ws.dsfinance.froihofer.net/", "TradingWSException");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.froihofer.dsfinance.ws.trading
     * 
     */
